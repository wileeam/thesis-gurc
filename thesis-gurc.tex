...
% See http://math.ucsd.edu/~msharpe/RcntFnts.pdf for details
...
% *** easier way of getting (La)TeX logos :)
\usepackage{hologo}
...
\begin{sidewaystable*}[t!]
    \centering
    % \small
    \begin{tabu}{>{\arraybackslash}m{3.75cm}LLL@{}m{0pt}@{}}
        \toprule
        ...
        \multirow{2}[4]{*}{Design Research Step} & \multicolumn{3}{c}{Articles} & \\
        \cmidrule(lr){2-4}
