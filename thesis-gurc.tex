...
painful labors}{Santiago Ram{\'o}n y Cajal} %1899
...
one entity, usually the \ac{osn} service provider, regardless of how such data is 
...
a centralised \ac{is} such as an \ac{osn} is one of the very first steps 
...
problem and the challenges our research faced to detail our reserach methodology 
in \cref{chapter:methodoloy}. Our contributions are listed in \cref{chapter:our-contributions} 
...
in \cref{part:published-articles}. Moreover, and for the reader's reference, we 
have also included selected excerpts of \ac{tos} from three popular \ac{osn} service 
providers in \cref{chapter:excerpts-of-tos-and-pp}.
...
% we introduce the reader to the main concepts that this thesis is based on --- although
% the reader should should not consider this background introduction a survey. We
% provide a brief background on \acp{is} in \cref{section:information-systems-on-the-importance-of-capabilities},
% centralised and decentralised \acp{osn} in \cref{section:osns-centralisation-vs-decentralisation}
% and privacy in \cref{section:privacy-a-never-ending-battle}.
...
mechanism --- to meet an objective'' \cite{StairR15}. And narrowed down in the domain 
of \ac{it} a \ac{cbis} is defined as a ``single set of hardware, software, databases, 
telecommunications, people, and procedures configured to collect, manipulate, store, 
and process data into information''. 

% Some experts list five basic elements of a CBIS: hardware, software, data, procedures and people. Others add a sixth element, communications, to the list.
...
this writing is dated on January 30th, 2015.

    The following is an excerpt of some selected sections of the \ac{tos}.
