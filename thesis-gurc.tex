...
\begin{abstract}
    ...
    Nonetheless, we hope that the privacy-preserving protocols we propose can be 
    useful in other scenarios to mitigate the diverse dangers to personal privacy 
...
% we want to show some alternatives to improve the control that the user can do on her personal data. 
