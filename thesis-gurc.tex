...
\begin{abstract}
    ...
    users' personal information in centralised \aclp*{osn}. As such, decentralised 
    solutions have been proposed to extend user's control over its data.
...
\acp{osn} have been on the news for different unfortunate reasons: 
%- name a few with links (censorship, misuse, data leakage, password hacking, etc)
%- Check Facebook's wikipedia: a nice encyclopedia of their mess...

Moreover, Snowden's revelations put the service providers of these \acp{osn} among 
many other big technological companies in the thick of a global surveillance program.
...
\acsetup{list-caps=true, list-heading=none}
\printacronyms
