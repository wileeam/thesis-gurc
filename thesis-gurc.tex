...
\input{template/doc/latex/kthesis/kth-bibl}
\begin{document}
\frontmatter
\maketitle
...
In 1989, while at the European Particle Physics Laboratory, at CERN, Tim Berners-Lee 
invented the World Wide Web. No one at that time would have imagined that such invention 
...
access to the Internet. Moreover, new intangible services and business opportunities 
have stemmed as technological developments matured, for example, in interpersonal 
communication.

The traditional exchange of physical letters as a means of communication between 
two parties, which still prevails, has evolved into a much more sophisticated and 
complex form in the information age. For example, e-mail is the parallelism in the 
digital era to such physical letters. However, the communication 
