...
\DeclareAcronym{glonass}{
    short        = GLONASS,
    %long         = Глобальная навигационная спутниковая система,
    long         = GLObalnaya navigatsionnaya sputnikovaya sistema,
    foreign      = global navigation satellite system,
    foreign-lang = english
}
