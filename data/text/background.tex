...
for such right to be considered and recognised in the \aca{usa} law. 
...
\namecref{chapter:thesis:introduction}. Though such presumption is not always necessarily 
...
Other example of \ac{dosn} leveraging in the social contacts is \Cachet where data 
availability and secure information retrieval is guaranteed \cite{NilizadehJMBK12}. 
Confidentiality is achieved by means of \ac{abe}, and data dissemination and availability 
is possible with an enriched \ac{dht} where users play an important role storing 
and transmitting to their contacts the recent updates from mutual contacts in the 
network.

Another \ac{dosn}, \PeerSoN, was built as a two-tiered \ac{p2p} architecture --- one 
...
A super-peer based \ac{dosn} approach is taken in \cite{SharmaD12} with \SuperNova. 

Finally, \Persona is another \ac{osn} implementation focusing on data control for the users 
...
% \DECENT and \Cachet: TODO
%
% \Diaspora, \Twister: TODO
%
% \VisVis: TODO
